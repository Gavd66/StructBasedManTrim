                ...
                Group {
                    ...
                    case .ake:
                        HStack {
                            ...
                            if underFloor.position22.hasBagsInLeft {
                                Text("Total Wt: \(underFloor.position22.bagWeightLeft) kg")
                                    .loadedStyle()
                            } else {
                                Text("AKE: 71kg ")
                                    .loadedStyle()
                    ...
                    case .cargo:
                        HStack {
                            ...
                            TextField("0 kg" , text: $underFloor.position22.cargoLeft
                                        .animation()
                                        .onChange(underFloor.position22.updateCargoRightLabels))
                                .textFieldStyle(RoundedBorderTextFieldStyle())
                ...
                Group {
                    ...
                    case .ake:
                        HStack {
                            ...
                            TextField("0 Bags", text: $underFloor.position22.bagCountRight
                                        .animation()
                                        .onChange(underFloor.position22.updateRightLabels))
                                .textFieldStyle(RoundedBorderTextFieldStyle())
                                .keyboardType(.numberPad)

                            if underFloor.position22.hasBagsInRight {
                                Text("Total Wt: \(underFloor.position22.bagWeightRight) kg")
                                    .loadedStyle()
                            } else {
                                Text("AKE: 71kg ")
                                    .loadedStyle()
                    ...
                    case .cargo:
                        HStack {
                            ...
                            TextField("0 kg" ,
                                      text: $underFloor.position22.cargoRight
                                        .animation()
